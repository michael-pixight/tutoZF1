...
class Application_Model_EntreprisesMapper{
    ...
    public function save(Application_Model_Entreprises $entreprises){
    ...
    public function find($id, Application_Model_Entreprises $entreprises){
        ...
        $entreprises->setId($row->id);
        $entreprises->setName($row->name);        
    }
    ...
    public function fetchAll(){
        ...
        {
            $entry = new Application_Model_Entreprises();
            $entry->setId($row->id);            
